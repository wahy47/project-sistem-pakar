...
(function (global, factory) {
    typeof exports === "object" && typeof module !== "undefined"
        ...
        : ((global = global || self),
          factory((global["bootstrap-autocomplete"] = {}), global.jQuery));
    ...
    var Autocomplete = /*#__PURE__*/ (function () {
                ...
                switch (e.keyCode) {
                    case KeyCode.ARROW_DOWN:
                        if (e.altKey && !_this._isShown) {
                            _this._query = _this._element.value
                                .trim()
                                .toLowerCase();
                    ...
                    case KeyCode.ENTER:
                        if (_this._isShown) {
                            var item = $(_this._dropdown)
                                .children(".active")
                                .get(0);
                            if (!item)
                                item = $(_this._dropdown)
        ...
        _proto._fetchPresetData = function _fetchPresetData() {
            ...
            if (this._config.prefetch) {
                ...
                $.get(this._config.prefetch, function (res) {
                    ...
                    if (_this2._config.preProcess)
                        res = _this2._config.preProcess(res);
        ...
        _proto._findFromAjax = function _findFromAjax() {
            ...
            this._timer = setTimeout(function () {
                ...
                var url = _this3._config.filter
                    .replace(/%23/g, "#")
                    .replace("#QUERY#", _this3._query);
                ...
                $.get(url, function (res) {
                    ...
                    if (_this3._config.preProcess)
                        res = _this3._config.preProcess(res);
                    var local = [];
                    res.forEach(function (i) {
                        var val = i.toLowerCase();
                    ...
                    if (_this3._result.length) _this3.show();
                    else _this3.hide();
                });
        ...
        _proto._makeSpinner = function _makeSpinner() {
            ...
            $(this._spinner).css({
                ...
                top:
                    ...
                    (this._element.offsetHeight - this._spinner.offsetHeight) /
                        2 +
                    "px",
            });
        ...
        _proto._renderItem = function _renderItem(items) {
            ...
            items.forEach(function (i) {
                if (
                    _this6._dropdown.children.length >= _this6._config.maxResult
                )
                    return;
                var item = $('<a class="dropdown-item" href="#"></a>');
                var itemEl = item.get(0);
                item.text(i).appendTo(_this6._dropdown);
                if (_this6._config.onItemRendered)
                    _this6._config.onItemRendered(_this6._element, itemEl);
        ...
        Autocomplete._jQueryInterface = function _jQueryInterface(
            config,
            relatedTarget
        ) {
