    ...
    <section id="hasil" class="d-flex align-items-center"
        ...
        <div class="container">
            <div class="row justify-content-evenly" style="margin-top: 100px">
                <div id="imgLeft" class="d-none d-sm-none d-md-none d-lg-block col-lg-5">
                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-penyakit" style="padding: 10px">
                                @foreach ($data as $item)
                                    @if ($item->nilai > 50)
                                        <div class="x row align-items-center">
                                            <div class="col-4">
    ...
    <section>
        <div class="container cons card p-5 shadow rounded">
            <div class="tabs">
                ...
                <div class="mb-3">
                    <h4 class="pills p-3">Gangguan Kecemasan Umum</h4>
                </div>
                <div class="mb-3">
                    <h4 class="pills p-3">Depresi</h4>
                </div>
            </div>
            <div class="tab-content">
                <div class="active p-3">
                    ...
                    <p><b>Obsessive Compulsive Disorder atau OCD merupakan bagian dari gangguan kecemasan yang membuat
                            penderitanya menghabiskan banyak waktu untuk melakukan hal yang sama berulang-ulang, sehingga
                    ...
                    <p>Tuangkan segala kekhawatiran dan atasi satu persatu, catat apakah masalah tersebut realistis atau
                        tidak dapat membantu. Pikirkan mengenai ketakutan dan tanyakan pada diri sendiri apakah ketakutan
                        ...
                        lainnya dan buatlah janji dengan seorang psikolog untuk menemukan strategi self-help tambahan untuk
                        situasi yang lebih spesifik.</p>

                </div>
                <div class="p-3">
                    <h2>Gangguan Kecemasan Umum</h2>
                    <p><b>Gangguan Kecemasan umum atau yang biasa disebut GAD (generalized anxiety disorder) merupakan salah
                            satu satu gangguan kecemasan yang dapat ditandai dengan adanya perasaan cemas yang berlebihan,
                            kecemasan ini biasanya terjadi karena penderita terlalu mengkhawatirkan segala hal yang terjadi
                    ...
                    <p>Bernapas dengan dalam dapat membuat tubuh relaks dan mengurangi aktivitas saraf di otak yang
                        menyebabkan rasa cemas. Ketika merasa cemas, fokus akan terganggu. Jika ini terjadi, cobalah untuk
                        ...
                        dapat membuat jantung berdetak lebih cepat dan memperburuk rasa cemas. Agar hasilnya optimal, Anda
                        disarankan untuk berkonsultasi ke dokter guna mendapat penanganan lebih lanjut.</p>

                </div>
                <div class="p-3">
                    <h2>Depresi</h2>
                    <p><b>Depresi merupakan salah satu penyakit mental yang paling umum terjadi saat ini, penderita depresi
                            biasanya memiliki gangguan emosional besar yang disebabkan oleh stress dan ketegangan yang dapat
                            menimbulkan munculnya keinginan untuk bunuh diri seiring waktu</b></p>

                    <h4>Cara Penanganan:</h4>
                    <p>Beberapa bentuk olahraga dapat membantu meningkatkan mood. Berjalan kaki selama 30 menit setiap hari
                        dapat membuat mood lebih baik dapat ditingkatkan dengan melakukan olahraga yang rutin. Penting untuk
                        memilih buah-buahan dan sayuran daripada makanan yang tinggi lemak dan gula. seperti ikan berlemak
                        yang mengandung banyak omega-3. Omega-3 terbukti dapat mengubah zat kimia pada otak yang bertugas
                        mengatur mood. memulai tidur dan bangun pada waktu yang sama setiap hari, pada waktu yang lama.
                        Jangan tidur siang terlalu lama, karena akan kesulitan untuk tidur kembali pada malam hari. Saran
                        terbaik adalah menantang mood buruk, lawan depresi dan ubah cara berpikir. Apabila merasa buruk,
                        cobalah untuk mengendalikan pikiran dan mulai memikirkan hal-hal positif. menikmati waktu bersama
